...
Version 4 outputs are structurally validated human-review artifacts. The runner deliberately does not decide whether an English gloss is semantically valid. `kai run check-qwen35-experiment` checks configuration and request construction without making API calls.
