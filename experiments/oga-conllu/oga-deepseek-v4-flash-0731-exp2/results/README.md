...
| `glm-5.3` | Proposed next | $1.4770 | $4.6420 | 6.36× | 6.67× | — |

`glm-5.3` costs 6.1% more for input and 11.1% more for output than DeepSeek V4 Pro. This table should be extended whenever another model is tested.
